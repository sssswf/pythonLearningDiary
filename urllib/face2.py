...
eye = cv2.imread('C:/Users/Desktop/test/')
#读取眼睛区域替换的图片
mouth = cv2.imread('C:/Users/Desktop/test/')
#读取嘴巴区域替换的图片
...
classifier_face = cv2.CascadeClassifier("F:/anaconda/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml")
#定义分类器（人脸识别）
classifier_eye = cv2.CascadeClassifier('F:/anaconda/Lib/site-packages/cv2/data/haarcascade_lefteye_2splits.xml')
#定义分类器（人眼识别）
classifier_mouth=cv2.CascadeClassifier('F:/anaconda/Lib/site-packages/cv2/data/haarcascade_smile.xml')
#定义分类器（嘴巴识别）
while (True):
